...
class AggregateFunction(exp.Expression):
    """
    ...
    def execute(self, environment):
        ...
        if countGr == 0:
            ...
            return primitive.Primitive(exp.TYPE.NUMBER, newDf, self.temp, self.row, self.column)
        if self.colData != "*":
        ...
        return primitive.Primitive(exp.TYPE.NUMBER, value, self.temp, self.row, self.column)
